...
| Case 9: BRENT calibration record | March 6 to September 6 ledger history, September 6 extraction | Thirty verbatim rows with five marked redactions, every probability change with its commit date, Brier on current and first-call marks; graded outcomes not re-sourced |
